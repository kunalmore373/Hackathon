...
const getMyApplications = async ( req , res ) => {
    try{
        const applications = await Application.find({ userId : req.user._id }).populate('universityId' , 'name country imageUrl tags') ;
...
// @desc    Update application status (e.g., move from Shortlisted -> Applying)
